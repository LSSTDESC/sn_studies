...
def plotcontour(ax,Nfields,Nseasons,cadence,nvmin,nvmax,slmin,slmax,color='k',ls='-'):
    ...
    NV,SL, BUD = budplot(Nfields,Nseasons,cadence,nvmin,nvmax,slmin,slmax)
    ...
    for l, s in zip(CS.levels, strs):
        fmt[l] = s
    ax.clabel(CS, inline=True, fontsize=10,colors=color,fmt=fmt)
...
Nseasons=10
plotcontour(ax,Nfields,Nseasons,cadence,nvmin,nvmax,slmin,slmax,color='r',ls='dashed')
