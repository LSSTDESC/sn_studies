...
class NSN_scenario:
    ...
    def __call__(self, config):
        ...
        for fieldName in config['fieldName']:
            ...
            nsn = np.round(nseasons*nfields*np.cumsum(nsn)[-1], 4)
            r.append(nsn)

        res = rf.append_fields(config, 'nsn', r)
...
r.append(('ELAIS', 0.64, 180., 1, 9.6, 2))
r.append(('CDFS', 0.64, 180., 1, 9.6, 2))
r.append(('ADFS', 0.64, 180., 2, 9.6, 2))
